...
def valid_letter_grade(letter_grade):
    ...
    if (letter_grade == 'A' or letter_grade == 'B' or letter_grade == 'C' or letter_grade == 'D' or letter_grade == 'F'
        or letter_grade == 'a' or letter_grade == 'b' or letter_grade == 'c' or letter_grade == 'd' or letter_grade == 'f'):
        return True
    else:
        return False
...
def get_grade_point_average(credit_points, grade_points):
    ...
    grade_point_average = grade_points / credit_points
